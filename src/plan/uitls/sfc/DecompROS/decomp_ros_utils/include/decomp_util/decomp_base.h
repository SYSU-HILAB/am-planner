...
class DecompBase
{
 public:
   ...
   *
   * This virtual bounding box is parallel to the line segment, the x,y,z axes are not
   * w.r.t the world coordinate system, but instead, x-axis is parallel to the line,
   * y-axis is perpendicular to the line and world z-axis, z-axis is perpendiculat to the
   * line and y-axis
   */
